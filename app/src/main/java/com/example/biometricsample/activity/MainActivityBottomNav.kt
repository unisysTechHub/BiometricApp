package com.example.biometricsample.activity
...
import com.example.biometricsample.databinding.ActivityMainBottomNavBinding
...
class MainActivityBottomNav : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_home, R.id.navigation_beneficiary_home, R.id.navigation_notifications
            )
        )
